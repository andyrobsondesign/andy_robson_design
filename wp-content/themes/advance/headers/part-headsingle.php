...
<div class="branding-single" <?php if ( function_exists( 'header_image' ) && header_image() ) : ?>style="background:url(<?php header_image(img/hero-header2); ?>)no-repeat center center /cover;" <?php endif; ?>>
 <div class="row"> 
