...
add_action( 'widgets_init', 'advance_widget_init' );
$args = array(
 'flex-width' => true,
 'width' => 1200,
 'flex-height' => true,
...
function advance_widget_init() {
	
	register_sidebar( array(
	    'name' =>__( 'Homepage sidebar', 'advance'),
	    'id' => 'sidebar-2',
	    'description' => __( 'Appears on the static front page template', 'advance' ),
