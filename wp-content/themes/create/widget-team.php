...
add_action( 'widgets_init', create_function( '', "register_widget('create_Team_Widget');" ) );
class create_Team_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        // Widget Slug
        $widget_slug = 'create-team-widget';
        ...
        // load widget
        parent::__construct( $widget_slug, 'create Team Grid', $widget_ops, $control_ops );
        ...
        if( $loop->have_posts() ) {
            ...
            while( $loop->have_posts() ) {
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class($class) ?>>
                    <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'create' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark">
                        <div class="overlay">
                        ...
                        <?php if(has_post_thumbnail()) : the_post_thumbnail( 'create_team_thumb' ); endif; ?>
                    </a>
                </div>
